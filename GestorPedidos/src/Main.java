import factory.*;      // 🔷 Abstract Factory (Creacional)
import pedido.*;
import envio.*;         // 🟢 Proxy (Estructural)
import validador.*;     // 🟡 Chain of Responsibility (Comportamiento)
import iterator.*;      // 🔁 Iterator (Libre elección)
